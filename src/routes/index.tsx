    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-border bg-background">
      <div className="flex h-[68px] w-full items-center justify-between gap-5 px-5 lg:h-[84px] lg:gap-8">
        ...
        <div className="flex items-center gap-6 lg:gap-8">
          <nav className="hidden items-center gap-8 text-[12px] font-black uppercase tracking-[0.18em] lg:flex">
      ...
      <div className="mx-auto flex w-full max-w-[1420px] flex-1 flex-col justify-center overflow-hidden px-5 pb-[36px] pt-[56px] sm:pt-[40px] lg:px-6 lg:pb-[72px]">
        <h1 className="hero-title max-w-full font-display text-[clamp(38px,12vw,50px)] font-black uppercase leading-[0.9] tracking-normal sm:text-[clamp(50px,8.4vw,128px)] sm:leading-[0.84]">
          <span className="hero-title-mask hero-title-mask-up">
            <span className="hero-title-line hero-title-center-reveal whitespace-nowrap">15 Years<br className="sm:hidden" /><span className="sm:hidden"> </span><span className="hidden sm:inline"> </span>Of</span>
          </span>
    ...
    <footer className="border-t border-border bg-background px-6 pb-20 pt-10 text-foreground md:px-12 md:py-16 md:pb-24 lg:px-24">
      ...
      <div className="flex flex-col items-center justify-between gap-8 border-t border-border pt-12 md:flex-row">
        ...
        <div className="flex gap-8 text-[10px] font-black uppercase tracking-[0.16em] text-muted-foreground">
          <a href="https://madmonkeyhostels.com/privacy-policy" target="_blank" rel="noopener noreferrer" className="transition-opacity hover:opacity-100">Privacy Policy</a>
          <a href="https://madmonkeyhostels.com/terms-and-conditions" target="_blank" rel="noopener noreferrer" className="transition-opacity hover:opacity-100">Terms of Service</a>
        </div>
      </div>
    </footer>
  );
